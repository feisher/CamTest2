...
import com.yusong.camtest.KtxConfig;
...
public final class ToastUtils {
    ...
    private static void show(final int resId, final int duration) {
        try {
            CharSequence text = KtxConfig.context.getResources().getText(resId);
            show(text, duration);
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.makeToast(KtxConfig.context, text, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.newToast(KtxConfig.context);
                iToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) KtxConfig.context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//            mParams.flags = WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON
            ...
            mParams.packageName = KtxConfig.context.getPackageName();
