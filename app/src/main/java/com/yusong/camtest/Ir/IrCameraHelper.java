...
/**
 * 相机辅助类,红外Ir摄像头有其特殊性，可能存在旋转角度问题
 */
public class IrCameraHelper implements Camera.PreviewCallback {
    ...
    private IrCameraHelper(Builder builder) {
...
//                parameters.setPreviewSize(720, 1280);
    ...
    private Camera.Size get480640Size(List<Camera.Size> sizes) {
...
//            start();
    ...
    public static final class Builder {
        ...
        public IrCameraHelper build() {
            ...
            return new IrCameraHelper(this);
        }
    }
